...
// Official Antigravity IDE & CLI fingerprint captured from live agy/IDE.
// Keep this static even when 9router runs on Linux: the provider profile is
// intentionally matching the client, not the server host.
export const ANTIGRAVITY_IDE_VERSION = "2.1.1";
export const ANTIGRAVITY_IDE_BASE_URL = "https://daily-cloudcode-pa.googleapis.com";
export const ANTIGRAVITY_IDE_USER_AGENT = "antigravity/cli/1.1.22 (aidev_client; os_type=linux; arch=amd64; cl=971564011; auth_method=consumer)";
